    ...
    <div class="border">
      <div class="content">
        ...
        <form id ="delete_message_form" unload = "document.delete_message_form.reload()" name ="select" method="post" action="delete.php" onclick="">
          ...
          $sql = "SELECT * FROM motw where motwID > (select max(motwID)-10 from motw) order by motwID desc;";
          ...
          { $title = $newArray['title'];
			...
			?>
              		...
              		<li>
                    <label>Message of the Week #<? echo $motwID ?> </label>
                    </li>
                    <li>
                    <label for="motwtitle"> Title </label><input type="text" id="motwtitle" name="motwtitle" value="<? echo $title; ?>" readonly="readonly"/>
                  	</li>
                  	<li>
                    <label for="entry"> Entry </label><textarea rows="6" cols="26" id="entry" name="entry" readonly="readonly" ><? echo $entry; ?> </textarea>
                    </li>
                    <li>
                    <label for="date"> Post Date </label><input type="text" id="date" name="date" value="<? echo $postDate; ?>" readonly="readonly" /> 
                    </li>
                    <li class="gap">
 					<label for="author"> Author </label><input type="text" id="author" name="author" value="<? echo $author; ?>" readonly="readonly" /> 
                    </li>
