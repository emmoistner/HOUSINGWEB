  ...
  <div class="inner-border">
    <div class="border">
      <div class="content">
        ...
        <form id ="supply_form" unload = "document.supply_form.reload()" name ="select" method="post" action="delete.php" onclick="return confirm('Are you sure you want to delete this item?');">
          <fieldset>
            <ol>
              ...
              <li class="bottom">
              <input name="deleteButton" value="Delete" type="submit" class="reset_button"  id="rst" onmouseover="onHoverReset()" onmouseout="onExitReset()" />
              </li>
            </ol>
          </fieldset>
        </form>
