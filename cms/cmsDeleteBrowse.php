...
<div class="body">
  <div class="inner-border">
    <div class="border">
      <div class="content">
        <h1 id="form-title"> Delete Browse </h1>
        <form id ="supply_form" unload = "document.supply_form.reload()" name ="select" method="post" onsubmit="return checkForm()" action="cmsDelete.php">
          <fieldset>
          <ol>
            <li class="Select">
