  ...
  <div class="inner-border">
    <div class="border">
      <div class="content">
        ...
        <form id ="supply_form" unload = "document.supply_form.reload()" name ="select" method="post" onsubmit="return checkForm()" action="employeeUpdateSelect.php" >
          <fieldset>
            <ol>
              <li class="Select">
                ...
                <select name = "supply" type="submit" id="supply" >
			  	...
			  	?>
                  <?
			  		$list=mysql_query("select id, Fname, Lname, Minit, Lname, PositionID, Birth_Date, BSU_Email from Employee order by Lname asc;");
