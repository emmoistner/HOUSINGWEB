...
<div class="body">
  <div class="inner-border">
    <div class="border">
      <div class="content">
        <h1 id="form-title"> Employee Manager</h1>
        <form id ="supply_form">
          <fieldset>
            <ol>
              <li class="Select">
                <label for="Select"> Employee CMS </label>
                <select name = "supply" onchange="window.document.location.href=this.options[this.selectedIndex].value;">
                  <option value="-1">CMS:</option>
                  <option value="addEmployee.php">Add</option>
                  <option value="employeeUpdateBrowse.php">Update</option>
                  <option value="employeeBrowse.php">Browse</option>
                </select>
            </ol>
          </fieldset>
        </form>
